...
for (let i = 0; i < buttons.length; i++) { // для размера кнопок
...
// Нажимаем кнопку на своей клавиатуре:
...
document.addEventListener('keydown', (event) => {
  ...
  // Клик мышкой по кнопке virtual_keyboard:
keyboard.addEventListener('click', (event) => {
  ...
  function runOnKeys(func, ...codes) {
    ...
    document.addEventListener('keydown', (event) => {
      ...
      for (let i = 0; i < codes.length; i++) { // те  ли клавиши из набора нажаты?
